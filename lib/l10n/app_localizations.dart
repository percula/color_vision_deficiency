...
abstract class AppLocalizations {
  ...
  /// No description provided for @protanomaly.
  ///
  /// In en, this message translates to:
  /// **'Protanomaly'**
  String get protanomaly;
  ...
  /// No description provided for @deuteranomaly.
  ///
  /// In en, this message translates to:
  /// **'Deuteranomaly'**
  String get deuteranomaly;
  ...
  /// No description provided for @tritanomaly.
  ///
  /// In en, this message translates to:
  /// **'Tritanomaly'**
  String get tritanomaly;
  ...
  /// No description provided for @achromatomaly.
  ///
  /// In en, this message translates to:
  /// **'Achromatomaly'**
  String get achromatomaly;

  /// No description provided for @percent.
  ///
  /// In en, this message translates to:
  /// **'{filter} ({percent} of population)'**
